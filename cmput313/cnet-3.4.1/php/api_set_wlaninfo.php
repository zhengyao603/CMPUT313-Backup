...
<dt>NAME</dt>
<dd>CNET_set_wlaninfo - set the transmission and reception characteristics of a WLAN link
<p></dd>
...
<b>int</b> CNET_set_wlaninfo(<b>int</b> link, WLANINFO *wlaninfo);
</div>
<p>
</dd>
...
<dt>DESCRIPTION</dt>
<dd>
<code>CNET_set_wlaninfo</code> sets the transmission and reception
characteristics of a link of type <code>LT_WLAN</code>.
</p>

<p>
<code>CNET_set_wlaninfo</code> assumes that its second argument is a pointer
...
<dt>NOTE</dt>
    <dd>No sanity checks are performed on the value of each field.
    </p>
    </dd>
